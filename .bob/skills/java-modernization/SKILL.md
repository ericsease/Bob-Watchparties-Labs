...
description: >
  Java 8 to Java 17+ modernization playbook. Use when modernizing, assessing, or
  auditing legacy Java code, migrating Spring Boot 2.x to 3.x, or applying modern
  Java idioms (records, var, LocalDateTime, streams, sealed classes). Also use when
  asked to read or assess Java source files and produce a modernization plan, migration
  plan, or gap analysis. Trigger phrases: "modernize", "migrate Java", "upgrade to
  Java 17", "Java modernization", "legacy Java", "assess the inventory service",
  "assess", "modernization plan", "migration plan", "java idioms", "security issues",
  "testability gaps", "missing infrastructure".
---
